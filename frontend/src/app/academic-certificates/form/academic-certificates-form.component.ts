...
@Component({
  selector: 'app-academic-certificates-form',
  templateUrl: './academic-certificates-form.component.html',
})
export class AcademicCertificatesFormComponent implements OnInit {
  form: FormGroup;
  schema: FormSchema;
