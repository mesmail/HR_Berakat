...
function label(name) {
  return i18n(`entities.academicCertificates.fields.${name}`);
}

const fields = {
  id: new IdField('id', label('id')),
  academicCertificates: new StringField('academicCertificates', label('academicCertificates'), {}),
...
export class AcademicCertificatesModel extends GenericModel {
  static get fields() {
    return fields;
  }
}
