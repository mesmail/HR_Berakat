...
import academicCertificatesExporterFields from 'src/app/academic-certificates/list/academic-certificates-exporter-fields';
...
export class AcademicCertificatesListService {
  rows = [];
  count = 0;
  loading = false;
  filter: any = {};
  ...
  async doExport() {
    try {
      ...
      const response = await AcademicCertificatesApi.list(
        filter,
        this.orderBy,
        null,
        null,
      ...
      new Exporter(
        academicCertificatesExporterFields,
