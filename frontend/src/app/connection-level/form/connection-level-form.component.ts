...
@Component({
  selector: 'app-connection-level-form',
  templateUrl: './connection-level-form.component.html',
})
export class ConnectionLevelFormComponent implements OnInit {
  form: FormGroup;
  schema: FormSchema;
