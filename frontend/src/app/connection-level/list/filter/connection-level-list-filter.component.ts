...
@Component({
  selector: 'app-connection-level-list-filter',
  templateUrl: './connection-level-list-filter.component.html',
})
export class ConnectionLevelListFilterComponent implements OnInit {
  form: FormGroup;
  schema: FilterSchema;
  expanded: boolean = false;

  constructor(
    private service: ConnectionLevelListService,
