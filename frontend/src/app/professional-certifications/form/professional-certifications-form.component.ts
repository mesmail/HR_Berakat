...
@Component({
  selector: 'app-professional-certifications-form',
  templateUrl: './professional-certifications-form.component.html',
})
export class ProfessionalCertificationsFormComponent implements OnInit {
  form: FormGroup;
  schema: FormSchema;
