...
@Component({
  selector: 'app-management-skills-list-filter',
  templateUrl: './management-skills-list-filter.component.html',
})
export class ManagementSkillsListFilterComponent implements OnInit {
  form: FormGroup;
  schema: FilterSchema;
  expanded: boolean = false;

  constructor(
    private service: ManagementSkillsListService,
