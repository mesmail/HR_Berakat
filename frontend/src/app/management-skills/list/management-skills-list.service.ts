...
import managementSkillsExporterFields from 'src/app/management-skills/list/management-skills-exporter-fields';
...
export class ManagementSkillsListService {
  rows = [];
  count = 0;
  loading = false;
  filter: any = {};
  ...
  async doExport() {
    try {
      ...
      const response = await ManagementSkillsApi.list(
        filter,
        this.orderBy,
        null,
        null,
      ...
      new Exporter(
        managementSkillsExporterFields,
        'managementSkills',
