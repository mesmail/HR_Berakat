...
@Component({
  selector: 'app-users-new-list-filter',
  templateUrl: './users-new-list-filter.component.html',
})
export class UsersNewListFilterComponent implements OnInit {
  form: FormGroup;
  schema: FilterSchema;
  expanded: boolean = false;

  constructor(
    private service: UsersNewListService,
