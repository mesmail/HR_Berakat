...
@Component({
  selector: 'app-claim-list-filter',
  templateUrl: './claim-list-filter.component.html',
})
export class ClaimListFilterComponent implements OnInit {
  form: FormGroup;
  schema: FilterSchema;
  expanded: boolean = false;

  constructor(
    private service: ClaimListService,
