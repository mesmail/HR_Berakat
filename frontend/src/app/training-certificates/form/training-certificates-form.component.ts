...
@Component({
  selector: 'app-training-certificates-form',
  templateUrl: './training-certificates-form.component.html',
})
export class TrainingCertificatesFormComponent implements OnInit {
  form: FormGroup;
  schema: FormSchema;
