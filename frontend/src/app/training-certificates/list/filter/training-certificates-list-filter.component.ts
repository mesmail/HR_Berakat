...
@Component({
  selector: 'app-training-certificates-list-filter',
  templateUrl: './training-certificates-list-filter.component.html',
})
export class TrainingCertificatesListFilterComponent implements OnInit {
  form: FormGroup;
  schema: FilterSchema;
  expanded: boolean = false;

  constructor(
    private service: TrainingCertificatesListService,
