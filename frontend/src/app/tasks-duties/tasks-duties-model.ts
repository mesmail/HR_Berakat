...
function label(name) {
  return i18n(`entities.tasksDuties.fields.${name}`);
}

const fields = {
  id: new IdField('id', label('id')),
  tasksDuties: new StringField('tasksDuties', label('tasksDuties'), {}),
...
export class TasksDutiesModel extends GenericModel {
  static get fields() {
    return fields;
  }
}
