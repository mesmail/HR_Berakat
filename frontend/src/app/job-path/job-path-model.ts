...
function label(name) {
  return i18n(`entities.jobPath.fields.${name}`);
}

const fields = {
  id: new IdField('id', label('id')),
  jobName: new StringField('jobName', label('jobName'), {}),
  promotionIndicators: new StringField('promotionIndicators', label('promotionIndicators'), {}),
...
export class JobPathModel extends GenericModel {
  static get fields() {
    return fields;
  }
}
