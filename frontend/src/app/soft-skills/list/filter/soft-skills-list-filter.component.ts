...
@Component({
  selector: 'app-soft-skills-list-filter',
  templateUrl: './soft-skills-list-filter.component.html',
})
export class SoftSkillsListFilterComponent implements OnInit {
  form: FormGroup;
  schema: FilterSchema;
  expanded: boolean = false;

  constructor(
    private service: SoftSkillsListService,
