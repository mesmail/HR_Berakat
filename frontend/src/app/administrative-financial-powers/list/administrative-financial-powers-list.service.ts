...
import administrativeFinancialPowersExporterFields from 'src/app/administrative-financial-powers/list/administrative-financial-powers-exporter-fields';
...
export class AdministrativeFinancialPowersListService {
  rows = [];
  count = 0;
  loading = false;
  filter: any = {};
  ...
  async doExport() {
    try {
      ...
      const response = await AdministrativeFinancialPowersApi.list(
        filter,
        this.orderBy,
        null,
        null,
      ...
      new Exporter(
        administrativeFinancialPowersExporterFields,
