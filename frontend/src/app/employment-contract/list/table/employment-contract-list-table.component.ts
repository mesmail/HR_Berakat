...
export class EmploymentContractListTableComponent {
  ...
  get columns() {
    return [
      ...
      this.fields.workingPeriod.name,
      this.fields.employmentSalary.name,
      this.fields.jobRoles.name,
      this.fields.employeeContactEmail.name,
      this.fields.mobileNumber.name,
      this.fields.homeAddress.name,
      this.fields.contractPeriod.name,
