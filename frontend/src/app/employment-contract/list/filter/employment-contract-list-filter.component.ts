  ...
  private buildSchema() {
    this.schema = new FilterSchema(
      [
        ...
        this.fields.workingPeriodRange,
        this.fields.employmentSalaryRange,
        this.fields.jobRoles,
        this.fields.employeeContactEmail,
        this.fields.mobileNumberRange,
        this.fields.homeAddress,
        this.fields.contractPeriodRange,
