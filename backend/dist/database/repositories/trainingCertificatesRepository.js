...
class TrainingCertificatesRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.trainingCertificates.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let record = yield options.database.trainingCertificates.findOne({
                where: {
                    id,
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const include = [];
            const currentTenant = sequelizeRepository_1.default.getCurrentTenant(options);
            const record = yield options.database.trainingCertificates.findOne({
                where: {
                    id,
                    tenantId: currentTenant.id,
                },
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.trainingCertificates.findAll({
                attributes: ['id'],
                where,
            });
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const transaction = sequelizeRepository_1.default.getTransaction(options);
            const tenant = sequelizeRepository_1.default.getCurrentTenant(options);
            return options.database.trainingCertificates.count({
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.trainingCertificates) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('trainingCertificates', 'trainingCertificates', filter.trainingCertificates));
                }
            ...
            let { rows, count, } = yield options.database.trainingCertificates.findAndCountAll({
                where,
                include,
    ...
    static findAllAutocomplete(query, limit, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (query) {
                whereAnd.push({
                    [Op.or]: [
                        ...
                        {
                            [Op.and]: sequelizeFilterUtils_1.default.ilikeIncludes('trainingCertificates', 'trainingCertificates', query),
                        },
                    ],
                });
            }
            const where = { [Op.and]: whereAnd };
            const records = yield options.database.trainingCertificates.findAll({
                attributes: ['id', 'trainingCertificates'],
                where,
                limit: limit ? Number(limit) : undefined,
                order: [['trainingCertificates', 'ASC']],
            });
    ...
    static _createAuditLog(action, record, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield auditLogRepository_1.default.log({
                entityName: 'trainingCertificates',
                entityId: record.id,
                action,
                values,
            }, options);
...
exports.default = TrainingCertificatesRepository;
//# sourceMappingURL=trainingCertificatesRepository.js.map