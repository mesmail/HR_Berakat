...
class ProfessionalCertificationsRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.professionalCertifications.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let record = yield options.database.professionalCertifications.findOne({
                where: {
                    id,
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const include = [];
            const currentTenant = sequelizeRepository_1.default.getCurrentTenant(options);
            const record = yield options.database.professionalCertifications.findOne({
                where: {
                    id,
                    tenantId: currentTenant.id,
                },
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.professionalCertifications.findAll({
                attributes: ['id'],
                where,
            });
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const transaction = sequelizeRepository_1.default.getTransaction(options);
            const tenant = sequelizeRepository_1.default.getCurrentTenant(options);
            return options.database.professionalCertifications.count({
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = '' }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.professionalCertifications) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('professionalCertifications', 'professionalCertifications', filter.professionalCertifications));
                }
            ...
            let { rows, count, } = yield options.database.professionalCertifications.findAndCountAll({
                where,
                include,
    ...
    static findAllAutocomplete(query, limit, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (query) {
                whereAnd.push({
                    [Op.or]: [
                        ...
                        {
                            [Op.and]: sequelizeFilterUtils_1.default.ilikeIncludes('professionalCertifications', 'professionalCertifications', query),
                        },
                    ],
                });
            }
            const where = { [Op.and]: whereAnd };
            const records = yield options.database.professionalCertifications.findAll({
                attributes: ['id', 'professionalCertifications'],
                where,
                limit: limit ? Number(limit) : undefined,
                order: [['professionalCertifications', 'ASC']],
            });
    ...
    static _createAuditLog(action, record, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield auditLogRepository_1.default.log({
                entityName: 'professionalCertifications',
                entityId: record.id,
                action,
                values,
            }, options);
...
exports.default = ProfessionalCertificationsRepository;
//# sourceMappingURL=professionalCertificationsRepository.js.map