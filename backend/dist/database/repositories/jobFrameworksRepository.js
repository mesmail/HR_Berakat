...
class JobFrameworksRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.jobFrameworks.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
                'takeMultipleTasks',
                'impactSalary',
                'impactJobGrade',
                'importHash',
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let record = yield options.database.jobFrameworks.findOne({
                where: {
                    id,
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const include = [];
            const currentTenant = sequelizeRepository_1.default.getCurrentTenant(options);
            const record = yield options.database.jobFrameworks.findOne({
                where: {
                    id,
                    tenantId: currentTenant.id,
                },
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.jobFrameworks.findAll({
                attributes: ['id'],
                where,
            });
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const transaction = sequelizeRepository_1.default.getTransaction(options);
            const tenant = sequelizeRepository_1.default.getCurrentTenant(options);
            return options.database.jobFrameworks.count({
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = '' }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.takeMultipleTasks) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('jobFrameworks', 'takeMultipleTasks', filter.takeMultipleTasks));
                }
                if (filter.impactSalary) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('jobFrameworks', 'impactSalary', filter.impactSalary));
                }
                if (filter.impactJobGrade) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('jobFrameworks', 'impactJobGrade', filter.impactJobGrade));
                }
            ...
            let { rows, count, } = yield options.database.jobFrameworks.findAndCountAll({
                where,
                include,
    ...
    static findAllAutocomplete(query, limit, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (query) {
                whereAnd.push({
                    [Op.or]: [
                        ...
                        {
                            [Op.and]: sequelizeFilterUtils_1.default.ilikeIncludes('jobFrameworks', 'takeMultipleTasks', query),
                        },
                    ],
                });
            }
            const where = { [Op.and]: whereAnd };
            const records = yield options.database.jobFrameworks.findAll({
                attributes: ['id', 'takeMultipleTasks'],
                where,
                limit: limit ? Number(limit) : undefined,
                order: [['takeMultipleTasks', 'ASC']],
            });
...
exports.default = JobFrameworksRepository;
//# sourceMappingURL=jobFrameworksRepository.js.map