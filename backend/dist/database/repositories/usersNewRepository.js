...
class UsersNewRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.usersNew.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
                'email',
                'firsrtName',
                'secondName',
                'phoneNumber',
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let record = yield options.database.usersNew.findOne({
                where: {
                    id,
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const include = [];
            const currentTenant = sequelizeRepository_1.default.getCurrentTenant(options);
            const record = yield options.database.usersNew.findOne({
                where: {
                    id,
                    tenantId: currentTenant.id,
                },
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.usersNew.findAll({
                attributes: ['id'],
                where,
            });
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const transaction = sequelizeRepository_1.default.getTransaction(options);
            const tenant = sequelizeRepository_1.default.getCurrentTenant(options);
            return options.database.usersNew.count({
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = '' }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.email) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('usersNew', 'email', filter.email));
                }
                if (filter.firsrtName) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('usersNew', 'firsrtName', filter.firsrtName));
                }
                if (filter.secondName) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('usersNew', 'secondName', filter.secondName));
                }
            ...
            let { rows, count, } = yield options.database.usersNew.findAndCountAll({
                where,
                include,
    ...
    static findAllAutocomplete(query, limit, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (query) {
                whereAnd.push({
                    [Op.or]: [
                        ...
                        {
                            [Op.and]: sequelizeFilterUtils_1.default.ilikeIncludes('usersNew', 'firsrtName', query),
                        },
                    ],
                });
            }
            const where = { [Op.and]: whereAnd };
            const records = yield options.database.usersNew.findAll({
                attributes: ['id', 'firsrtName'],
                where,
                limit: limit ? Number(limit) : undefined,
                order: [['firsrtName', 'ASC']],
            });
...
exports.default = UsersNewRepository;
//# sourceMappingURL=usersNewRepository.js.map