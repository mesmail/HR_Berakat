...
class AdministrativeFinancialPowersRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.administrativeFinancialPowers.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let record = yield options.database.administrativeFinancialPowers.findOne({
                where: {
                    id,
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const include = [];
            const currentTenant = sequelizeRepository_1.default.getCurrentTenant(options);
            const record = yield options.database.administrativeFinancialPowers.findOne({
                where: {
                    id,
                    tenantId: currentTenant.id,
                },
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.administrativeFinancialPowers.findAll({
                attributes: ['id'],
                where,
            });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.administrativeFinancialPowers) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('administrativeFinancialPowers', 'administrativeFinancialPowers', filter.administrativeFinancialPowers));
                }
            ...
            let { rows, count, } = yield options.database.administrativeFinancialPowers.findAndCountAll({
                where,
                include,
...
exports.default = AdministrativeFinancialPowersRepository;
//# sourceMappingURL=administrativeFinancialPowersRepository.js.map