...
class ConnectionLevelRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.connectionLevel.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
                'external',
                'internal',
                'importHash',
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let record = yield options.database.connectionLevel.findOne({
                where: {
                    id,
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const include = [];
            const currentTenant = sequelizeRepository_1.default.getCurrentTenant(options);
            const record = yield options.database.connectionLevel.findOne({
                where: {
                    id,
                    tenantId: currentTenant.id,
                },
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.connectionLevel.findAll({
                attributes: ['id'],
                where,
            });
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = '' }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.external) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('connectionLevel', 'external', filter.external));
                }
                if (filter.internal) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('connectionLevel', 'internal', filter.internal));
                }
            ...
            let { rows, count, } = yield options.database.connectionLevel.findAndCountAll({
                where,
                include,
...
exports.default = ConnectionLevelRepository;
//# sourceMappingURL=connectionLevelRepository.js.map