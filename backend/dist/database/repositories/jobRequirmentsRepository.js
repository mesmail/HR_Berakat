...
class JobRequirmentsRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.jobRequirments.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
                'tactLevel',
                'experienceYears',
                'minKPI',
                'importHash',
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let record = yield options.database.jobRequirments.findOne({
                where: {
                    id,
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const include = [];
            const currentTenant = sequelizeRepository_1.default.getCurrentTenant(options);
            const record = yield options.database.jobRequirments.findOne({
                where: {
                    id,
                    tenantId: currentTenant.id,
                },
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.jobRequirments.findAll({
                attributes: ['id'],
                where,
            });
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = '' }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.tactLevel) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('jobRequirments', 'tactLevel', filter.tactLevel));
                }
                ...
                if (filter.minKPI) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('jobRequirments', 'minKPI', filter.minKPI));
                }
            ...
            let { rows, count, } = yield options.database.jobRequirments.findAndCountAll({
                where,
                include,
...
exports.default = JobRequirmentsRepository;
//# sourceMappingURL=jobRequirmentsRepository.js.map