...
class ClientsRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.clients.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
                'clientName',
                'jobCount',
                'clientIndustry',
                'importHash',
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let record = yield options.database.clients.findOne({
                where: {
                    id,
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const include = [];
            const currentTenant = sequelizeRepository_1.default.getCurrentTenant(options);
            const record = yield options.database.clients.findOne({
                where: {
                    id,
                    tenantId: currentTenant.id,
                },
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.clients.findAll({
                attributes: ['id'],
                where,
            });
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const transaction = sequelizeRepository_1.default.getTransaction(options);
            const tenant = sequelizeRepository_1.default.getCurrentTenant(options);
            return options.database.clients.count({
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.clientName) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('clients', 'clientName', filter.clientName));
                }
                if (filter.jobCountRange) {
                    const [start, end] = filter.jobCountRange;
                ...
                if (filter.clientIndustry) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('clients', 'clientIndustry', filter.clientIndustry));
                }
            ...
            let { rows, count, } = yield options.database.clients.findAndCountAll({
                where,
                include,
            ...
            if (query) {
                whereAnd.push({
                    [Op.or]: [
                        ...
                        {
                            [Op.and]: sequelizeFilterUtils_1.default.ilikeIncludes('clients', 'clientName', query),
                        },
                    ],
                });
            }
