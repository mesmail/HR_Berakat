...
class CommonComiteesRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.commonComitees.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
                'addedCommittee',
                'menus',
                'importHash',
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let record = yield options.database.commonComitees.findOne({
                where: {
                    id,
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const include = [];
            const currentTenant = sequelizeRepository_1.default.getCurrentTenant(options);
            const record = yield options.database.commonComitees.findOne({
                where: {
                    id,
                    tenantId: currentTenant.id,
                },
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.commonComitees.findAll({
                attributes: ['id'],
                where,
            });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.addedCommittee) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('commonComitees', 'addedCommittee', filter.addedCommittee));
                }
                if (filter.menus) {
                    whereAnd.push({
                        menus: filter.menus,
            ...
            let { rows, count, } = yield options.database.commonComitees.findAndCountAll({
                where,
                include,
...
exports.default = CommonComiteesRepository;
//# sourceMappingURL=commonComiteesRepository.js.map