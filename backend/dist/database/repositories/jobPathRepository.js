...
class JobPathRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.jobPath.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
                'jobName',
                'promotionIndicators',
                'importHash',
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let record = yield options.database.jobPath.findOne({
                where: {
                    id,
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const include = [];
            const currentTenant = sequelizeRepository_1.default.getCurrentTenant(options);
            const record = yield options.database.jobPath.findOne({
                where: {
                    id,
                    tenantId: currentTenant.id,
                },
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.jobPath.findAll({
                attributes: ['id'],
                where,
            });
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = '' }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.jobName) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('jobPath', 'jobName', filter.jobName));
                }
                if (filter.promotionIndicators) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('jobPath', 'promotionIndicators', filter.promotionIndicators));
                }
            ...
            let { rows, count, } = yield options.database.jobPath.findAndCountAll({
                where,
                include,
...
exports.default = JobPathRepository;
//# sourceMappingURL=jobPathRepository.js.map