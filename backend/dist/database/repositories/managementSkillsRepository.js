...
class ManagementSkillsRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.managementSkills.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
                'managementSkills',
                'importHash',
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let record = yield options.database.managementSkills.findOne({
                where: {
                    id,
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const include = [];
            const currentTenant = sequelizeRepository_1.default.getCurrentTenant(options);
            const record = yield options.database.managementSkills.findOne({
                where: {
                    id,
                    tenantId: currentTenant.id,
                },
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.managementSkills.findAll({
                attributes: ['id'],
                where,
            });
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const transaction = sequelizeRepository_1.default.getTransaction(options);
            const tenant = sequelizeRepository_1.default.getCurrentTenant(options);
            return options.database.managementSkills.count({
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.managementSkills) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('managementSkills', 'managementSkills', filter.managementSkills));
                }
            ...
            let { rows, count, } = yield options.database.managementSkills.findAndCountAll({
                where,
                include,
    ...
    static findAllAutocomplete(query, limit, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (query) {
                whereAnd.push({
                    [Op.or]: [
                        ...
                        {
                            [Op.and]: sequelizeFilterUtils_1.default.ilikeIncludes('managementSkills', 'managementSkills', query),
                        },
                    ],
                });
            }
            const where = { [Op.and]: whereAnd };
            const records = yield options.database.managementSkills.findAll({
                attributes: ['id', 'managementSkills'],
                where,
                limit: limit ? Number(limit) : undefined,
                order: [['managementSkills', 'ASC']],
            });
...
exports.default = ManagementSkillsRepository;
//# sourceMappingURL=managementSkillsRepository.js.map