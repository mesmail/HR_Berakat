...
class AcademicCertificatesRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.academicCertificates.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let record = yield options.database.academicCertificates.findOne({
                where: {
                    id,
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const include = [];
            const currentTenant = sequelizeRepository_1.default.getCurrentTenant(options);
            const record = yield options.database.academicCertificates.findOne({
                where: {
                    id,
                    tenantId: currentTenant.id,
                },
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.academicCertificates.findAll({
                attributes: ['id'],
                where,
            });
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const transaction = sequelizeRepository_1.default.getTransaction(options);
            const tenant = sequelizeRepository_1.default.getCurrentTenant(options);
            return options.database.academicCertificates.count({
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.academicCertificates) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('academicCertificates', 'academicCertificates', filter.academicCertificates));
                }
            ...
            let { rows, count, } = yield options.database.academicCertificates.findAndCountAll({
                where,
                include,
    ...
    static findAllAutocomplete(query, limit, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (query) {
                whereAnd.push({
                    [Op.or]: [
                        ...
                        {
                            [Op.and]: sequelizeFilterUtils_1.default.ilikeIncludes('academicCertificates', 'academicCertificates', query),
                        },
                    ],
                });
            }
            const where = { [Op.and]: whereAnd };
            const records = yield options.database.academicCertificates.findAll({
                attributes: ['id', 'academicCertificates'],
                where,
                limit: limit ? Number(limit) : undefined,
                order: [['academicCertificates', 'ASC']],
            });
    ...
    static _createAuditLog(action, record, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield auditLogRepository_1.default.log({
                entityName: 'academicCertificates',
                entityId: record.id,
                action,
                values,
            }, options);
...
exports.default = AcademicCertificatesRepository;
//# sourceMappingURL=academicCertificatesRepository.js.map