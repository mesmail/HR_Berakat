...
class TasksDutiesRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.tasksDuties.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
                'tasksDuties',
                'importHash',
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let record = yield options.database.tasksDuties.findOne({
                where: {
                    id,
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const include = [];
            const currentTenant = sequelizeRepository_1.default.getCurrentTenant(options);
            const record = yield options.database.tasksDuties.findOne({
                where: {
                    id,
                    tenantId: currentTenant.id,
                },
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.tasksDuties.findAll({
                attributes: ['id'],
                where,
            });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.tasksDuties) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('tasksDuties', 'tasksDuties', filter.tasksDuties));
                }
            ...
            let { rows, count, } = yield options.database.tasksDuties.findAndCountAll({
                where,
                include,
...
exports.default = TasksDutiesRepository;
//# sourceMappingURL=tasksDutiesRepository.js.map