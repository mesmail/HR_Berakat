...
class ClaimRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.claim.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
                'problemDescription',
                'importHash',
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let record = yield options.database.claim.findOne({
                where: {
                    id,
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const include = [];
            const currentTenant = sequelizeRepository_1.default.getCurrentTenant(options);
            const record = yield options.database.claim.findOne({
                where: {
                    id,
                    tenantId: currentTenant.id,
                },
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.claim.findAll({
                attributes: ['id'],
                where,
            });
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const transaction = sequelizeRepository_1.default.getTransaction(options);
            const tenant = sequelizeRepository_1.default.getCurrentTenant(options);
            return options.database.claim.count({
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.problemDescription) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('claim', 'problemDescription', filter.problemDescription));
                }
            ...
            let { rows, count, } = yield options.database.claim.findAndCountAll({
                where,
                include,
    ...
    static findAllAutocomplete(query, limit, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (query) {
                whereAnd.push({
                    [Op.or]: [
                        ...
                        {
                            [Op.and]: sequelizeFilterUtils_1.default.ilikeIncludes('claim', 'problemDescription', query),
                        },
                    ],
                });
            }
            const where = { [Op.and]: whereAnd };
            const records = yield options.database.claim.findAll({
                attributes: ['id', 'problemDescription'],
                where,
                limit: limit ? Number(limit) : undefined,
                order: [['problemDescription', 'ASC']],
            });
...
//# sourceMappingURL=claimRepository.js.map