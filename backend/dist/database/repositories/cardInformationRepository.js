...
class CardInformationRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.cardInformation.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
                'version',
                'date',
                'generalManager',
                'hRManager',
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let record = yield options.database.cardInformation.findOne({
                where: {
                    id,
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const include = [];
            const currentTenant = sequelizeRepository_1.default.getCurrentTenant(options);
            const record = yield options.database.cardInformation.findOne({
                where: {
                    id,
                    tenantId: currentTenant.id,
                },
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.cardInformation.findAll({
                attributes: ['id'],
                where,
            });
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = '' }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.version) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('cardInformation', 'version', filter.version));
                }
                if (filter.dateRange) {
                ...
                if (filter.generalManager) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('cardInformation', 'generalManager', filter.generalManager));
                }
                if (filter.hRManager) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('cardInformation', 'hRManager', filter.hRManager));
                }
            ...
            let { rows, count, } = yield options.database.cardInformation.findAndCountAll({
                where,
                include,
...
exports.default = CardInformationRepository;
//# sourceMappingURL=cardInformationRepository.js.map