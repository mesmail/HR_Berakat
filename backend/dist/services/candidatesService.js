...
const candidatesRepository_1 = __importDefault(require("../database/repositories/candidatesRepository"));
...
class CandidatesService {
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                data.currentPosition = yield jobsRepository_1.default.filterIdInTenant(data.currentPosition, Object.assign(Object.assign({}, this.options), { transaction }));
                data.academicCertificateSpecialization = yield academicCertificatesRepository_1.default.filterIdInTenant(data.academicCertificateSpecialization, Object.assign(Object.assign({}, this.options), { transaction }));
                ...
                data.artisticSkills = yield artisticSkillsRepository_1.default.filterIdInTenant(data.artisticSkills, Object.assign(Object.assign({}, this.options), { transaction }));
                data.jobs = yield jobsRepository_1.default.filterIdInTenant(data.jobs, Object.assign(Object.assign({}, this.options), { transaction }));
                const record = yield candidatesRepository_1.default.create(data, Object.assign(Object.assign({}, this.options), { transaction }));
                ...
                sequelizeRepository_1.default.handleUniqueFieldError(error, this.options.language, 'candidates');
                throw error;
            }
        });
    }
    update(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                data.artisticSkills = yield artisticSkillsRepository_1.default.filterIdInTenant(data.artisticSkills, Object.assign(Object.assign({}, this.options), { transaction }));
                data.jobs = yield jobsRepository_1.default.filterIdInTenant(data.jobs, Object.assign(Object.assign({}, this.options), { transaction }));
                const record = yield candidatesRepository_1.default.update(id, data, Object.assign(Object.assign({}, this.options), { transaction }));
                yield sequelizeRepository_1.default.commitTransaction(transaction);
                return record;
            }
            catch (error) {
    ...
    destroyAll(ids) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (const id of ids) {
                    yield candidatesRepository_1.default.destroy(id, Object.assign(Object.assign({}, this.options), { transaction }));
                }
                yield sequelizeRepository_1.default.commitTransaction(transaction);
            }
            catch (error) {
    ...
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return candidatesRepository_1.default.findById(id, this.options);
        });
    }
    findAllAutocomplete(search, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            return candidatesRepository_1.default.findAllAutocomplete(search, limit, this.options);
        });
    }
    findAndCountAll(args) {
        return __awaiter(this, void 0, void 0, function* () {
            return candidatesRepository_1.default.findAndCountAll(args, this.options);
        });
    }
    ...
    _isImportHashExistent(importHash) {
        return __awaiter(this, void 0, void 0, function* () {
            const count = yield candidatesRepository_1.default.count({
                importHash,
            }, this.options);
            return count > 0;
        });
...
//# sourceMappingURL=candidatesService.js.map