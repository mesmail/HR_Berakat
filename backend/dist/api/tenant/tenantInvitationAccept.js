...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const payload = yield new tenantService_1.default(req).acceptInvitation(req.params.token, Boolean(req.body.forceAcceptOtherEmail));
...
//# sourceMappingURL=tenantInvitationAccept.js.map