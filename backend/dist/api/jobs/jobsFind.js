...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.jobsRead);
        const payload = yield new jobsService_1.default(req).findById(req.params.id);
...
//# sourceMappingURL=jobsFind.js.map