...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.jobsEdit);
        const payload = yield new jobsService_1.default(req).update(req.params.id, req.body.data);
...
//# sourceMappingURL=jobsUpdate.js.map