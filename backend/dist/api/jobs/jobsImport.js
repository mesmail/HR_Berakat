...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.jobsImport);
        yield new jobsService_1.default(req).import(req.body.data, req.body.importHash);
        const payload = true;
...
//# sourceMappingURL=jobsImport.js.map