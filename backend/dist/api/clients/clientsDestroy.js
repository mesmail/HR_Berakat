...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.clientsDestroy);
        yield new clientsService_1.default(req).destroyAll(req.query.ids);
        const payload = true;
...
//# sourceMappingURL=clientsDestroy.js.map